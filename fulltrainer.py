...
if args.mode == 'train':
    ...
    weights_filename = '{}dqn_{}_v{}_weights.h5f'.format(currentpath, args.env_name, args.version)
    checkpoint_weights_filename = 'dqn_' + args.env_name + '_weights_{step}.h5f'
    log_filename = '{}dqn_{}_v{}_log.json'.format(currentpath, args.env_name, args.version)
