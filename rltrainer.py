...
if args.mode == 'train':
    ...
    weights_filename = '{}dqn0_{}_v{}_weights.h5f'.format(currentpath, args.env_name, args.myversion)
    checkpoint_weights_filename = 'dqn0_' + args.env_name + '_weights_{step}.h5f'
    log_filename = '{}dqn0_{}_v{}_log.json'.format(currentpath, args.env_name, args.myversion)
